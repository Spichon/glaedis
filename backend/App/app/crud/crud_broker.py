...
class CRUDBroker(CRUDBase[Broker, BrokerCreate, BrokerUpdate]):
    ...
    #                     base_asset_broker = self.add_asset(db=db, asset_in=asset_b, broker_in=broker, obj_in=asset_broker_in)
    ...
    #                     quote_asset_broker = self.add_asset(db=db, asset_in=asset_q, broker_in=broker, obj_in=asset_broker_in)
